...
class CreateYTT1DraftsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('y_t_t1_drafts', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->mediumText('information21')->nullable();
            $table->mediumText('information22')->nullable();
            $table->mediumText('information23')->nullable();
    ...
    {
        Schema::dropIfExists('y_t_t1_drafts');
    }
}
